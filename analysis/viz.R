...
mm2pt <- 1/2.83464566929134 ## convert pt to mm
...
### MPPC
                 ...
                 ,
### bamfiles
                  ac27=ggplot(tracks.this$ac27,aes(xmin=start-offset,xmax=end-offset,ymax=y,ymin=0)) + geom_rect(col="black",fill="black") + ggtitle("H3K27ac"),
